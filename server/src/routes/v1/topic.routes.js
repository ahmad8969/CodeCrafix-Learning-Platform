...
const { topicCreate, topicUpdate, mongoId, reorderBody } = require('../../validators/curriculum.validator')
...
router.post('/', requirePermission(COURSE_PERMISSIONS.MANAGE_CURRICULUM), topicCreate, validate, controller.create)
